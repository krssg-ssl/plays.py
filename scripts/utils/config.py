...
DBOX_WIDTH                   = SELECT(600,1200)       #Along X direction
DBOX_HEIGHT                  = SELECT(600,855)        #Along Y direction(hal height in each y direction)
